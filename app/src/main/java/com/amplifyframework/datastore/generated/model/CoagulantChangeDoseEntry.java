...
/** This is an auto generated class representing the CoagulantChangeDoseEntry type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "CoagulantChangeDoseEntries", type = Model.Type.USER, version = 1)
@Index(name = "coChByPlantByOperatorByDate", fields = {"plantID","operatorID","creationDateTime"})
@Index(name = "byOperator", fields = {"operatorID"})
public final class CoagulantChangeDoseEntry implements Model {
  public static final QueryField ID = field("CoagulantChangeDoseEntry", "id");
  public static final QueryField PLANT_ID = field("CoagulantChangeDoseEntry", "plantID");
  public static final QueryField OPERATOR_ID = field("CoagulantChangeDoseEntry", "operatorID");
  public static final QueryField CREATION_DATE_TIME = field("CoagulantChangeDoseEntry", "creationDateTime");
  public static final QueryField CHEMICAL_FLOW_RATE = field("CoagulantChangeDoseEntry", "chemicalFlowRate");
  public static final QueryField CHEMICAL_DOSE = field("CoagulantChangeDoseEntry", "chemicalDose");
  public static final QueryField SLIDER_POSITION = field("CoagulantChangeDoseEntry", "sliderPosition");
  public static final QueryField TARGET_CHEMICAL_DOSE = field("CoagulantChangeDoseEntry", "targetChemicalDose");
  public static final QueryField UPDATED_SLIDER_POSITION = field("CoagulantChangeDoseEntry", "updatedSliderPosition");
  public static final QueryField UPDATED_CHEMICAL_FLOW_RATE = field("CoagulantChangeDoseEntry", "updatedChemicalFlowRate");
  public static final QueryField CHEMICAL_TYPE = field("CoagulantChangeDoseEntry", "chemicalType");
  ...
  private CoagulantChangeDoseEntry(String id, String plantID, String operatorID, Temporal.DateTime creationDateTime, Double chemicalFlowRate, Double chemicalDose, Double sliderPosition, Double targetChemicalDose, Double updatedSliderPosition, Double updatedChemicalFlowRate, Double chemicalType) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      CoagulantChangeDoseEntry coagulantChangeDoseEntry = (CoagulantChangeDoseEntry) obj;
      return ObjectsCompat.equals(getId(), coagulantChangeDoseEntry.getId()) &&
              ObjectsCompat.equals(getPlantId(), coagulantChangeDoseEntry.getPlantId()) &&
              ObjectsCompat.equals(getOperatorId(), coagulantChangeDoseEntry.getOperatorId()) &&
              ObjectsCompat.equals(getCreationDateTime(), coagulantChangeDoseEntry.getCreationDateTime()) &&
              ObjectsCompat.equals(getChemicalFlowRate(), coagulantChangeDoseEntry.getChemicalFlowRate()) &&
              ObjectsCompat.equals(getChemicalDose(), coagulantChangeDoseEntry.getChemicalDose()) &&
              ObjectsCompat.equals(getSliderPosition(), coagulantChangeDoseEntry.getSliderPosition()) &&
              ObjectsCompat.equals(getTargetChemicalDose(), coagulantChangeDoseEntry.getTargetChemicalDose()) &&
              ObjectsCompat.equals(getUpdatedSliderPosition(), coagulantChangeDoseEntry.getUpdatedSliderPosition()) &&
              ObjectsCompat.equals(getUpdatedChemicalFlowRate(), coagulantChangeDoseEntry.getUpdatedChemicalFlowRate()) &&
              ObjectsCompat.equals(getChemicalType(), coagulantChangeDoseEntry.getChemicalType()) &&
              ObjectsCompat.equals(getCreatedAt(), coagulantChangeDoseEntry.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), coagulantChangeDoseEntry.getUpdatedAt());
      }
  }
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      .append("CoagulantChangeDoseEntry {")
   ...
   */
  public static CoagulantChangeDoseEntry justId(String id) {
    return new CoagulantChangeDoseEntry(
      id,
      null,
      null,
      null,
  ...
  public interface BuildStep {
    CoagulantChangeDoseEntry build();
  ...
  public static class Builder implements PlantIdStep, OperatorIdStep, CreationDateTimeStep, ChemicalFlowRateStep, ChemicalDoseStep, SliderPositionStep, TargetChemicalDoseStep, UpdatedSliderPositionStep, UpdatedChemicalFlowRateStep, ChemicalTypeStep, BuildStep {
    ...
    @Override
     public CoagulantChangeDoseEntry build() {
  ...
  public static class CoagulantChangeDoseEntryIdentifier extends ModelIdentifier<CoagulantChangeDoseEntry> {
    private static final long serialVersionUID = 1L;
    public CoagulantChangeDoseEntryIdentifier(String id) {
      super(id);
    }
  }
