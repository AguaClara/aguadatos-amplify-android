...
/** This is an auto generated class representing the RawWaterEntry type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "RawWaterEntries", type = Model.Type.USER, version = 1)
@Index(name = "rwByPlantByOperatorByDate", fields = {"plantID","operatorID","creationDateTime"})
@Index(name = "byOperator", fields = {"operatorID"})
public final class RawWaterEntry implements Model {
  public static final QueryField ID = field("RawWaterEntry", "id");
  public static final QueryField PLANT_ID = field("RawWaterEntry", "plantID");
  public static final QueryField OPERATOR_ID = field("RawWaterEntry", "operatorID");
  public static final QueryField CREATION_DATE_TIME = field("RawWaterEntry", "creationDateTime");
  public static final QueryField ADDITIONAL_NOTES = field("RawWaterEntry", "additionalNotes");
  public static final QueryField TURBIDITY = field("RawWaterEntry", "turbidity");
  ...
  private RawWaterEntry(String id, String plantID, String operatorID, Temporal.DateTime creationDateTime, String additionalNotes, Double turbidity) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      RawWaterEntry rawWaterEntry = (RawWaterEntry) obj;
      return ObjectsCompat.equals(getId(), rawWaterEntry.getId()) &&
              ObjectsCompat.equals(getPlantId(), rawWaterEntry.getPlantId()) &&
              ObjectsCompat.equals(getOperatorId(), rawWaterEntry.getOperatorId()) &&
              ObjectsCompat.equals(getCreationDateTime(), rawWaterEntry.getCreationDateTime()) &&
              ObjectsCompat.equals(getAdditionalNotes(), rawWaterEntry.getAdditionalNotes()) &&
              ObjectsCompat.equals(getTurbidity(), rawWaterEntry.getTurbidity()) &&
              ObjectsCompat.equals(getCreatedAt(), rawWaterEntry.getCreatedAt()) &&
              ObjectsCompat.equals(getUpdatedAt(), rawWaterEntry.getUpdatedAt());
      }
  }
   ...
   */
  public static RawWaterEntry justId(String id) {
    return new RawWaterEntry(
      id,
      null,
      null,
      null,
