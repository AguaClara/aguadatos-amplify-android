...
public final class ChlorineCalibrationEntry implements Model {
  ...
  public static class ChlorineCalibrationEntryIdentifier extends ModelIdentifier<ChlorineCalibrationEntry> {
    private static final long serialVersionUID = 1L;
    public ChlorineCalibrationEntryIdentifier(String id) {
      super(id);
    }
  }
