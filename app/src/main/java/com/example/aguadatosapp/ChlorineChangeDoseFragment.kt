...
class ChlorineChangeDoseFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_chlorine_change_dose, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val calibrationEntry: DoubleArray? = viewModel.chlorineCalibrationData.value
        val changeDoseEntry: DoubleArray? = viewModel.chlorineChangeDoseData.value
        ...
        if(calibrationEntry != null && changeDoseEntry != null) {
            ...
            val newChlorineFlowDisplay: TextView = view.findViewById(R.id.new_chlorine_flow_display)
