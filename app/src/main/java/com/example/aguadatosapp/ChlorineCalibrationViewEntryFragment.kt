...
class ChlorineCalibrationViewEntryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //inflate layout
        val view = inflater.inflate(R.layout.fragment_chlorine_calibration_view_entry, container, false)

        // handle logic for return home button
        view.findViewById<Button>(R.id.go_home_button).setOnClickListener {
            findNavController().navigate(R.id.action_chlorine_view_to_home)
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // This view model contains the chlorine dosing data entry
